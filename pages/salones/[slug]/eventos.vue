    ...
    <NuxtLayout name="layout-contenido">
            ...
            <div class="flex flex-col md:flex-row space-x-2">
                ...
                <client-only>
                    <VCalendar id="calendar" ref="calendar" :view="calendarView" :is-dark="isDark"
                        class="transition-padding duration-300 z-10"
                        :class="{ 'pt-16': isHeaderVisible && calendarView == 'weekly' }" borderless :rows="rows"
                        :expanded="expanded" :masks="masks" :attributes="attributes" locale="es"
                        :min-date="periodo.startDate" :max-date="periodo.endDate" :initial-page="initialPage"
                        @dayclick="onDayClicked" @daymouseenter="onDayMouseEnter" @daymouseleave="onDayMouseLeft"
                        ...
                        <div v-for="evento in fechasVisibles" :key="evento.id" :ref="el => evtRefs[evento.id] = el"
                            ...
                            <div class="flex">
                                ...
                                <div class="event-actions flex">
                                    ...
                                    <Button v-if="puedeEditar" icon="pi pi-pencil mt-2 dark:text-zinc-400" size="small" text rounded
        ...
        <Dialog v-model:visible="mostrarVentanaEdit" modal :header="ventanaEditHeader" :style="{ width: '25rem' }"
            ...
            <div class="flex gap-2 mb-4 flex-col md:flex-row">
                ...
                <DatePicker dateFormat="dd/mm/yy" id="fecha" v-model="eventoEditando.fecha" class="w-full"
                    :minDate="new Date(periodo.startDate)" :maxDate="new Date(periodo.endDate)" showTime hourFormat="24"
                    fluid />
            </div>
            ...
            <div class="flex gap-2 mb-10 flex-col md:flex-row">
                ...
                <Textarea id="desc" class="w-full leading-normal" v-model="eventoEditando.descripcion" rows="5"
                    cols="30" />
            </div>
            ...
            <div class="text-right flex justify-end gap-x-2">
                ...
                <!-- Btn Cancelar -->
                <Button type="submit" class="" label="Cancelar" severity="secondary" :disabled="loadingEdit"
                    @click="mostrarVentanaEdit = false" />
                <!-- Btn Guardar -->
