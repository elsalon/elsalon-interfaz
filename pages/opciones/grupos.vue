<template>
    <template v-if="salonStore.gruposDelUsuarioFetching">
        <div class="my-4 text-center text-zinc-500 text-sm">
    ...
    <template v-else>
        <div class="text-center mt-10">
            <p class="my-10 text-zinc-500">Podés crear grupos de trabajo con tus compañerxs para postear colectivamente y compartir una bitácora de progeso</p>
