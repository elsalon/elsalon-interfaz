...
<form @submit.prevent="GuardarEvento">
                <div class="flex gap-2 mb-4 flex-col md:flex-row">
                    ...
                    <DatePicker dateFormat="dd/mm/yy" id="fecha" v-model="eventoEditando.fecha" autofocus required class="w-full"
                ...
                <div class="text-right flex justify-end gap-x-2">
                    <!-- Btn Cancelar -->
                    <Button type="button" label="Cancelar" severity="secondary" :disabled="loadingEdit"
