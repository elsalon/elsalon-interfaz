export default {
    root: ({ props, context, parent, instance }) => ({
        class: [
            ...
            { '': !props.rounded, 'rounded-md': props.rounded, 'rounded-md': props.round },
            ...
            // Plain Button
            { 'text-white bg-neutral-500 border border-gray-500 outline-dashed': props.plain && !props.outlined && !props.text },
            // Plain Text Button
