<template>
    <div>
        <div class="w-full text-center">
            <Button v-if="hasNextPage && !fetchingComentarios" link class="my-2 text-zinc-600 dark:text-zinc-400 text-xs"
                @click="fetchComentarios" :label="`Ver más comentarios (${comentariosRestantes})`"/>
        </div>

        <div v-if="fetchingComentarios" class="my-2 w-full text-center text-zinc-600 dark:text-zinc-400 text-sm">
