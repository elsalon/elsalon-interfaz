<template>
    <div class="relative group/aprecio w-max">
        <Button link class="my-2 text-xs text-surface-500" style="padding: 0" :label="tooltipText"  v-tooltip.notrigger="{ html:tooltipText, autoHide: false }" @click="handleAprecioClicked" />
