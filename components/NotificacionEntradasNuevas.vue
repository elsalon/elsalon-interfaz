<template>
    <Transition name="slide-fade">
        <div class="entradasNuevasNotification" v-if="visible">
            <div @click="IrAEntradasRecientes" class="text-white hover:text-zinc-600">Ver entradas nuevas</div>
            <div @click="Ocultar"><i class="pi pi-times text-white hover:text-zinc-600" style="font-size: .6rem;"></i>
            </div>
        </div>
    </Transition>
</template>
